...
class WarpData(BaseModel):
    ...
    def parse_warp_block(cls, block) -> "WarpData":
        data = {
            ...
            "five": WarpData._extract_list(block, "S级代理人") or WarpData._extract_list(block, "S级音擎"),
            "four": WarpData._extract_list(block, "A级代理人") or WarpData._extract_list(block, "A级音擎"),
        }
        value = cls(**data)
