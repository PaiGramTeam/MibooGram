...
roles = {
    ...
    1051: ["伊德海莉", "Yidhari", "yidhari", "章鱼妹"],
    1061: ["可琳", "Corin", "corin", "可琳·威克斯"],
    1071: ["凯撒", "Caesar", "caesar", "凯撒·金"],
    1081: ["比利", "Billy", "billy", "比利·奇德"],
    1091: ["雅", "Miyabi", "unagi", "星见雅", "星见 雅"],
    ...
    1171: ["柏妮思", "Burnice", "burnice", "柏妮思·怀特"],
    1181: ["格莉丝", "Grace", "lisa", "格莉丝·霍华德"],
    1191: ["艾莲", "Ellen", "ellen", "艾莲·乔"],
    1201: ["悠真", "Harumasa", "harumasa", "浅羽悠真", "浅羽 悠真", "闪现哥", "义兄"],
    1211: ["丽娜", "Rina", "rina", "亚历山德丽娜·莎芭丝缇安"],
    1221: ["柳", "Yanagi", "yanagi", "月城柳", "月城 柳"],
    1241: ["朱鸢", "Zhu Yuan", "zhuyuan", "朱鸢"],
    1251: ["青衣", "QingYi", "qingyi", "青衣"],
    1261: ["简", "Jane", "jane", "简"],
    1271: ["赛斯", "Seth", "seth", "赛斯·洛威尔", "公子哥"],
    1281: ["派派", "Piper", "clara", "派派·韦尔"],
    1291: ["雨果", "Hugo", "hugo"],
    1301: ["奥菲丝&「鬼火」", "Orphie & Magus", "orphie & magus"],
    1311: ["耀嘉音", "Astra Yao", "astrayao", "yaojiayin"],
    1321: ["伊芙琳", "Evelyn", "evelyn"],
    1331: ["薇薇安", "Vivian", "vivian"],
    1341: ["照", "Zhao", "zhao"],
    1351: ["波可娜", "Pulchra", "pulchra"],
    1361: ["「扳机」", "Trigger", "trigger"],
    1371: ["仪玄", "Yixuan", "yixuan"],
    1381: ["零号·安比", "Soldier 0 - Anby"],
    1391: ["橘福福", "Ju Fufu", "ju fufu"],
    1401: ["爱丽丝", "Alice", "alice"],
    ...
    1531: ["星徽·比利", "Starlight - Billy", "starlight - billy", "billy - starlight"],
    1541: ["普罗米娅", "Promeia", "promeia"],
    1551: ["佩洛伊斯", "Pyrois", "pyrois"],
    1561: ["维琳娜", "Velina", "velina"],
    1571: ["诺姆", "Norma", "norma"],
    1581: ["蕾米埃尔", "Remielle", "remielle"],
    1591: ["希格莉德", "Sigrid", "sigrid"],
    1611: ["克拉蕾", "Claret", "claret"],
    1621: ["洛克茜", "Roxy", "roxy"],
}
not_real_roles = [2011, 2021, 1551]
not_real_roles.extend([1621])
weapons = {
    12001: ["「月相」-望"],
    12002: ["「月相」-晦"],
    12003: ["「月相」-朔"],
